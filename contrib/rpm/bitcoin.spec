...
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15583
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 15584
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 25583
%{_sbindir}/semanage port -a -t bitcoin_port_t -p tcp 25584
...
if [ $1 -eq 0 ]; then
	if [ `%{_sbindir}/sestatus |grep -c "disabled"` -eq 0 ]; then
	%{_sbindir}/semanage port -d -p tcp 15583
	%{_sbindir}/semanage port -d -p tcp 15584
	%{_sbindir}/semanage port -d -p tcp 25583
	%{_sbindir}/semanage port -d -p tcp 25584
