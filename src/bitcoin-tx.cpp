...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s escudonavacense-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  escudonavacense-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded escudonavacense transaction") + "\n" +
              "  escudonavacense-tx [options] -create [commands]   " + _("Create hex-encoded escudonavacense transaction") + "\n" +
              "\n";
