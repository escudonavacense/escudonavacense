...
These are the dependencies currently used by EscudoNavacense Core. You can find instructions for installing them in the `build-*.md` file for your platform.
