...
"""Verify that starting escudonavacense with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start escudonavacense with -h for help text")
        ...
        self.log.info("Start escudonavacense with -version for version information")
